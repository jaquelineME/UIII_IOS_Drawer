...
class MelendezApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EsScaffold(title: 'Flutter en Español Meléndez'),
    ); // fin de materialApp
  } // fin de widget
} // fin de MelendezApp
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          ...
          Text('Drawer 1 por Meléndez'),
        ]), //Fin de columna
      ), //Fin drawer1
      endDrawer: Drawer(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          FlutterLogo(size: 100.0),
          Text('Drawer 2 por Meléndez'),
        ]), //Fin de columna
      ), //Fin drawer2
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text('bottomNavigationBar Jaqueline Meléndez')
            ],
          ),
        ),
      ), //Fin de bottomAppBar
